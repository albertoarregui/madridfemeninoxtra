...
async function run() {
    try {
        console.log("Borrando la columna agencia de la tabla contratos...");
        await client.execute("ALTER TABLE contratos DROP COLUMN agencia;");
        console.log("Columna 'agencia' eliminada con éxito.");
    } catch (e) {
