    ...
    try {
        ...
        const query = `
            SELECT 
                ...
                d.dorsal,
                d.foto_url,
                (SELECT COUNT(*) FROM goles_y_asistencias g WHERE g.id_partido = a.id_partido AND (g.goleadora = a.id_jugadora OR g.goleadora = CAST(j.id_jugadora AS TEXT))) as goles,
                (SELECT COUNT(*) FROM goles_y_asistencias g WHERE g.id_partido = a.id_partido AND (g.asistente = a.id_jugadora OR g.asistente = CAST(j.id_jugadora AS TEXT))) as asistencias,
                ...
                e.valoracion, e.pases_clave, e.tiros_totales, e.tiros_puerta, e.toques, e.toques_area_rival,
                ...
                e.fueras_juego, e.regates_completados, e.regates_totales, e.perdidas, e.entradas,
...
export const fetchGamesDirectly = (options: MatchReadOptions = {}) =>
    fetchGamesDirectlyUncached(options);
