...
async function run() {
    try {
        console.log("Adding agencia column back to contratos to circumvent Turso Studio bug...");
        await client.execute("ALTER TABLE contratos ADD COLUMN agencia TEXT;");
        console.log("Column 'agencia' added successfully to 'contratos'.");
    } catch (e) {
